                        ...
                        <div class="flex flex-wrap items-center mt-6">
                            <p class="flex text-lg md:text-xl drop-shadow-md">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    ...
                                    ?>
                                    <span class="<?php echo e($color); ?> text-2xl md:text-4xl px-0.5 md:px-1 hover:scale-110 transition-transform duration-200"></span>
                                    <?php endfor; ?>
                            </p>
                    ...
                    <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg p-8">
                        ...
                        <div class="space-y-4 mt-8">
                            ...
                            <div class="flex items-start space-x-4 py-2">
                                <div class="flex-1">
                                    <div class="text-black dark:text-white font-semibold mb-2"><?php echo e($c->user->name); ?></div>
                                    <div>
                                    ...
                                    <p class="text-neutral-700 dark:text-neutral-200 ps-1"><?php echo e($c->comment); ?></p>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $c)): ?> <!-- Periksa izin untuk menghapus -->
...
<?php endif; ?><?php /**PATH /home/eroge/Documents/review-film/resources/views/detail.blade.php ENDPATH**/ ?>