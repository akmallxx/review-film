    ...
    <div class="p-4 md:p-5 space-y-4">
        ...
        <form action="<?php echo e($url); ?>" method="POST" enctype="multipart/form-data" class="mx-auto">
            ...
            <div id="poster_url" class="mb-5" style="<?php echo e($film->poster_method == 'url' ? '' : 'display: none;'); ?>">
                ...
                <input type="text" name="poster_url" id="poster_url_input" value="<?php echo e($film->poster_url); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan URL Poster" required />
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-5">
                    ...
                    <input type="text" name="kategori_umur" id="kategori_umur" value="<?php echo e($film->kategori_umur); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Kategori Umur" required />
                </div>
                <div class="mb-5">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eroge/Documents/review-film/resources/views/admin/film/create.blade.php ENDPATH**/ ?>