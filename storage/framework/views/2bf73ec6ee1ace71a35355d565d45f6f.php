...
<?php $__env->startSection('content'); ?>
    ...
    <div class="p-4 md:p-5 space-y-4">
        ...
        ?>
        <form action="<?php echo e($url); ?>" method="POST" enctype="multipart/form-data" class="mx-auto">
            <?php echo csrf_field(); ?>
            <?php if($id): ?>
            ...
            <div id="poster_url" class="mb-5" style="<?php echo e($film->poster_method == 'url' ? '' : 'display: none;'); ?>">
                ...
                <input type="text" name="poster_url" id="poster_url_input" value="<?php echo e(str_starts_with($film->poster_url, 'http://127.0.0.1:8000/storage') ? '' : $film->poster_url); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan URL Poster" required />
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="text" name="judul" id="judul" value="<?php echo e($film->judul); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Judul" required />
            </div>
            ...
            <div class="mb-5">
                    ...
                    <input type="number" name="total_episode" id="total_episode" value="<?php echo e($film->total_episode); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Total Episode" required />
                </div>
                <div class="mb-5">
                    <label for="tahun_rilis" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Tahun Rilis</label>
                    <input type="number" name="tahun_rilis" id="tahun_rilis" value="<?php echo e($film->tahun_rilis); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Tahun Rilis" required />
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-5">
                    ...
                    <input type="number" name="durasi" id="durasi" value="<?php echo e($film->durasi); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Durasi" required />
                </div>
                <div class="mb-5">
                    <label for="pencipta" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Pencipta</label>
                    <input type="text" name="pencipta" id="pencipta" value="<?php echo e($film->pencipta); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Pencipta" required />
                </div>
            </div>

            <div class="mb-5">
                <label for="trailer" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Trailer URL</label>
                <input type="text" name="trailer" id="trailer" value="<?php echo e($film->trailer); ?>" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan URL Trailer" required />
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-5">
                    ...
                    <select name="kategori_umur" id="kategori_umur" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        <option value="" <?php echo $id ? '' : 'selected'; ?> disabled>Pilih Kategori</option>
                        <option value="13+" <?php echo e($film->kategori_umur == '13+' ? 'selected' : ''); ?>>13+</option>
                        <option value="16+" <?php echo e($film->kategori_umur == '16+' ? 'selected' : ''); ?>>16+</option>
                        <option value="17+" <?php echo e($film->kategori_umur == '17+' ? 'selected' : ''); ?>>17+</option>
                        <option value="18+" <?php echo e($film->kategori_umur == '18+' ? 'selected' : ''); ?>>18+</option>
                        <option value="21+" <?php echo e($film->kategori_umur == '21+' ? 'selected' : ''); ?>>21+</option>
                    </select>
                </div>
                <div class="mb-5">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\NGODING\review-film\resources\views/admin/film/create.blade.php ENDPATH**/ ?>