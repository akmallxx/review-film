<?php $__env->startSection('title', 'CRUD Users'); ?>
    ...
    <div class="p-4 md:p-5 space-y-4">
        ...
        <form action="<?php echo e($url); ?>" method="POST" class="mx-auto">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="name" id="name" value="<?php echo e($user->name ?? ''); ?>" required class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Nama" required />
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <select name="role" id="role" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    <option value="admin" <?php echo e(isset($user) && $user->hasRole('admin') ? 'selected' : ''); ?>>Admin</option>
                    <option value="user" <?php echo e(isset($user) && $user->hasRole('user') ? 'selected' : ''); ?>>User</option>
                    <option value="author" <?php echo e(isset($user) && $user->hasRole('author') ? 'selected' : ''); ?>>Author</option>
                </select>
            </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('admin.users')); ?>" class="py-2.5 px-5 text-sm font-medium text-neutral-900 focus:outline-none bg-white rounded-lg border border-neutral-200 hover:bg-neutral-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-neutral-100 dark:focus:ring-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:border-neutral-600 dark:hover:text-white dark:hover:bg-neutral-700">Batal</a>
            </div>
        </form>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\NGODING\review-film\resources\views/admin/users/create.blade.php ENDPATH**/ ?>