<?php $__env->startSection('title', 'Series - ' . config('app.name', 'Laravel')); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12 max-w-7xl mx-auto">
        <form action="<?php echo e(route('series')); ?>" method="GET" class="mb-12">
            <div class="relative">
...
<?php endif; ?><?php /**PATH /home/eroge/Documents/review-film/resources/views/series.blade.php ENDPATH**/ ?>