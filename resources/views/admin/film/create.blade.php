    ...
    <div class="p-4 md:p-5 space-y-4">
        ...
        <form action="{{ $url }}" method="POST" enctype="multipart/form-data" class="mx-auto">
            ...
            <div id="poster_url" class="mb-5" style="{{ $film->poster_method == 'url' ? '' : 'display: none;' }}">
                ...
                <input type="text" name="poster_url" id="poster_url_input" value="{{ $film->poster_url }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan URL Poster" required />
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="text" name="judul" id="judul" value="{{ $film->judul }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Judul" required />
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="mb-5">
                    ...
                    <input type="number" name="tahun_rilis" id="tahun_rilis" value="{{ $film->tahun_rilis }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Tahun Rilis" required />
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-5">
                    ...
                    <input type="number" name="durasi" id="durasi" value="{{ $film->durasi }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Durasi" required />
                </div>
                <div class="mb-5">
                    <label for="pencipta" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Pencipta</label>
                    <input type="text" name="pencipta" id="pencipta" value="{{ $film->pencipta }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Pencipta" required />
                </div>
            </div>

            <div class="mb-5">
                <label for="trailer" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Trailer URL</label>
                <input type="text" name="trailer" id="trailer" value="{{ $film->trailer }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan URL Trailer" required />
            </div>

            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-5">
                    <label for="kategori_umur" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Kategori Umur</label>
                    <input type="text" name="kategori_umur" id="kategori_umur" value="{{ $film->kategori_umur }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Kategori Umur" required />
                </div>
                <div class="mb-5">
                    <label for="total_episode" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Total Episode</label>
                    <input type="number" name="total_episode" id="total_episode" value="{{ $film->total_episode }}" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Total Episode" required />
                </div>
            </div>
