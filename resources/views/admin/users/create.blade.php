...
@section('content')
    ...
    <div class="p-4 md:p-5 space-y-4">
        ...
        <form action="{{ $url }}" method="POST" class="mx-auto">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="mb-5">
                    ...
                    <select name="role" id="role"
                        ...
                        <option value="author" {{ isset($user) && $user->hasRole('author') ? 'selected' : '' }}>Author
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="mb-5">
                <label for="password" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Password
