    ...
    <div class="p-4 md:p-5 space-y-4">
        ...
        <form action="{{ $url }}" method="POST" class="mx-auto">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="title" id="title" value="{{ $genre->title ?? '' }}" required class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Nama" required />
            </div>
